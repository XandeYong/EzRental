                                ...
                                <table class="table table-bordered table-responsive table-light">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="bg-white">{{ $roomVisitAppointmentDetails[0]->appointment_id }}</td> 

                                            <th scope="row" class="w-25">Request Appointment date</th>
                                            <td class="bg-white w-25">{{ date('Y-m-d', strtotime($roomVisitAppointmentDetails[0]->created_at)) }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="bg-white">{{ Str::ucfirst($roomVisitAppointmentDetails[0]->status) }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Appointment Date</th>
                                            <td colspan="3" class="bg-white">{{ date('Y-m-d', strtotime($roomVisitAppointmentDetails[0]->datetime)) }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Appointment Time</th>
                                            <td colspan="3" class="bg-white">{{ date('g:i A', strtotime($roomVisitAppointmentDetails[0]->datetime)) }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Note</th>
                                            <td colspan="3" class="bg-white">{{ $roomVisitAppointmentDetails[0]->note }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
