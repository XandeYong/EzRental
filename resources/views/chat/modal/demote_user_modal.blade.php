{{-- Demote User Modal --}}
<div class="modal modal-lg fade" id="demote_user_modal" tabindex="-1" aria-labelledby="create group modal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">

            <form action="{{ route('chat.group.user.demote') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Demote User from the Group</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="accountID" class="form-label">Demote User<span class="c-red">*</span></label>
